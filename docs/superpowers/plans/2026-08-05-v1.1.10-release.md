...
- [ ] **Step 3: 新增 `update_app_settings` 类方法**
...
- [ ] **Step 4: `handle_get_config` 返回这三项**
...
- [ ] **Step 5: `handle_config_save` 保存这三项**
