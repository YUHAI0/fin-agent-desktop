...
const api = {
  ...
  listAnalysisFavorites: () => ipcRenderer.invoke('list-analysis-favorites'),
  listWatchlist: () => ipcRenderer.invoke('list-watchlist'),
  getWatchlistStatus: (tsCode: string) => ipcRenderer.invoke('get-watchlist-status', tsCode),
  addWatchlist: (payload: object) => ipcRenderer.invoke('add-watchlist', payload),
  setWatchlistGroup: (payload: object) => ipcRenderer.invoke('set-watchlist-group', payload),
  setWatchlistAlertPct: (payload: object) => ipcRenderer.invoke('set-watchlist-alert-pct', payload),
  removeWatchlist: (id: string) => ipcRenderer.invoke('remove-watchlist', id),
